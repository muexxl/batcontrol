...
class DynamicTariff:
    ...
    def create_tarif_provider(
        ...
        cache_manager, http_client, rate_limit_manager = DynamicTariff._get_shared_infrastructure()
        logger.debug(f"Creating {provider} provider with shared infrastructure")
        ...
        logger.info(f"Created {provider} tariff provider")
